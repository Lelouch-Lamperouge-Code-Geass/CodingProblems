...
/***
更新 : 上面的思路有问题。玻璃有三块反射面，让我们定义“最终反射点”为一束光永远离开玻璃们的最后的反射点， 
那么如果“最终反射点”在两个外层玻璃的反射光可以衍生出 两个  +1 反射的反射光。而“最终反射点”在中间的反射光只能衍生出一条 +1 反射的反射光。
另外一个特性在于如果这次最终反射点在中间的玻璃，那么下一个反射点必然在外层玻璃， 而这次最终反射点在外层玻璃，那么必然下次反射有两个反射点，
一个在内层玻璃而一个在外层玻璃。
